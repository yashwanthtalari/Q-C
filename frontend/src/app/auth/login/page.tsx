    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden dark">
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-6">
          ...
          <p className="text-slate-400 text-sm mt-1">Sign in to your teacher portal account</p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-3xl border border-white/10 shadow-2xl relative">
          ...
          <div className="text-center mt-6 text-sm text-slate-400">
            ...
            <Link href="/auth/signup" className="text-indigo-400 hover:text-indigo-300 font-semibold transition-all">
              Sign Up
            </Link>
          </div>
        </div>
